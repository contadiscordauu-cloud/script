    ...
    Toggle.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            elseif text == "RIGHT" then
                if enabled then openRightPanel() else closeRightPanel() end
            elseif text == "AUTOBAT" then
                AutoBatPanel.Visible = enabled
                if not enabled then
            ...
            elseif text == "INFJUMP" then
                jumpActive = enabled
            elseif text == "SPIN" then
                if enabled then enableSpin() else disableSpin() end
            ...
            elseif text == "UNWALK" then
                if enabled then enableUnwalk() else disableUnwalk() end
